...
AI. You will be given a detailed description of an Australian occupation from \
Jobs and Skills Australia (based on the ANZSCO classification).
...
Examples: roofer, concreter, commercial diver, livestock farmer.
...
core job. \
Examples: electrician, plumber, firefighter, dental hygienist, aged care worker.
...
Examples: registered nurse, police officer, veterinarian, physiotherapist.
...
Examples: teacher, manager, accountant, journalist, civil engineer.
...
Examples: data entry clerk, telemarketer, medical transcriptionist.
